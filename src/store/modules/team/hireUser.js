...
const state = {
    sub: {
        ...
        error: false,
        fieldErrors: {},
        successMsg: 'User was hired successfully.',
        loading: false,
        unauthorized: null,
        unverified: null,
        notfound: false,
...
// actions
const actions = {
    hireUser ({ dispatch, commit, state }, dargs) {
        // Loading
    ...
    confirmHire ({ dispatch, commit, state }, dargs) {
        // Loading
        if (dargs.noLoad !== true) {
            commit('loading')
        } else if (dargs.loader) {
