<template>
    <el-dialog :visible="show_test_modal"
      width="40%"
      :show-close="false"
      >
  <!-- sds    {{accepting}}  -->
          ...
          <div slot="title">
            ...
            <!-- {{module}} -->
                <div class="row" align="center">
                 ...
                 <i :class="{'fa':true,'fa-3x':true,'fa-globe':!testing,'fa-spinner fa-spin':testing}"></i>
                 <br>
                 <a  target="_blank" :href="testUrl">{{testUrl}}</a>
                            <!-- <i class="fa fa-spinner fa-3x fa-spin " align="center"></i>            -->
...
props: ["show_test_modal","testing","testUrl"],
methods:{
