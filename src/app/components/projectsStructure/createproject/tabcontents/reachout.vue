<template>
    <span>
        <div class="well creat-modules">
            ...
            <div class="row">
                <div class="col-md-6 text-center">
                    <div class="well proj-reach-well">
                        <h4 class="text-center">Call Us </h4>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatum voluptatibus adipisci non sed numquam?</p>
                        <button class="btn btn-primary text-center">Call Us</button>
                    </div>
                </div>
                <div class="col-md-6 text-center">
                    <div class="well proj-reach-well">
                            <h4 class="text-center">Chat Us</h4>
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deleniti ad iusto vel hic possimus quos odit .</p>
                        <button class="btn btn-primary text-center">Chat Us</button>
                    </div>
                </div>
        ...
        <p class="text-right next-button">
            <button class="btn btn-default" @click.stop="goBack">Back</button>&nbsp;&nbsp;
            <button v-if="!loading" class="btn btn-default" @click.stop="createProject">Create Project</button>
            <LoadingButton buttonclass="btn btn-default" v-else>Creating...</LoadingButton>
        </p>
    </span>
</template>
