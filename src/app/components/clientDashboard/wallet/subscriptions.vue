    ...
    <el-dialog :visible="show"
      ...
      :before-close="beforeClose">
        ...
        <!-- Modal content-->
          ...
          <h4>Zeedas Pay Subscription</h4>
        </div>
          <div class="modal-body">
            <div v-for="member in team" class="personal-details row">
                <div class="col-xs-3 text-center">
                    <div class="profile-img">
                        <img :src="imageLink(user)" width="40" height="40" />
                    </div>
                ...
                <div class="col-xs-5">
                    <div class="col-xs-8 text-center"><label for="">Actions</label><br></div>
                    <button class="btn btn-default" @click.stop="goInvite">
                        Pay&nbsp;
                            <i class="ion-ios-checkmark finish-checkmark"></i>
                    </button>
                    <button class="btn btn-default" style="padding: 8px 40px" @click.stop="$_$closeModal">
                        Skip
                    </button>
            ...
            <div v-show="team.length === 0">
                
                <p class="text-center">
                    <span class="text-center">No Team Members for this Account</span>
                    <br><br>
                    <button class="btn btn-default cancel" @click.stop="$_$closeModal">
                        Cancel
                    </button>
                    <button class="btn btn-primary invite" @click.stop="goInvite">
                        Invite Team Members&nbsp;
                            <i class="ion-ios-checkmark finish-checkmark"></i>
                    </button>
                </p>
...
export default {
  ...
  methods: {
    ...
    goInvite(){
        // this.$router.push('/user/dashboard/team');
        this.$show_notification("Done");
    },
    calculateTotal(){
        this.total = this.months * this.rate;
    }
