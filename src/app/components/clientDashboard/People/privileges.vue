<template>
<div class="my-fucking-side-bar" v-if="show" >
	<br>
	<br>
	<br>
<i @click="closeMod()" class="ion-ios-close-empty pull-right fa-2x" style="display:block;margin-right:10px;cursor:pointer;" ></i>
	<br>
	<br>
<span class="update">Privileges</span>
...
<div class="col-md-12" style="padding:38px!important">
		   <form @submit.prevent="validateBeforeSubmit">
         	<div class="row" v-for="permission in permissions" style="margin-bottom:20px">
         		<!-- {{permission}} -->
         		<div class="col-md-6">
         			<span class="project center-block">{{fixPermission(permission.Permission)}}</span>
         		</div>
         		<div class="col-md-6">
...
.z{
	...
	padding-bottom: 20%
	   ...
	   .my-fucking-side-bar:hover::-webkit-scrollbar{
      width: 5px;
      transition: all 1s ease;
  }
   .my-fucking-side-bar::-webkit-scrollbar {
      width: 0px;

      transition: all 1s ease;
  }
   .my-fucking-side-bar::-webkit-scrollbar-thumb {
      border-radius: 50px;
   ...
   .my-fucking-side-bar::-webkit-scrollbar-track {
